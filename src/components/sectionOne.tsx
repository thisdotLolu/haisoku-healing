...
const SectionOne = () => {
  return (
    <div className='mx-auto  max-w-[1920px] px-4 sm:px-6 2xl:px-7 3xl:px-8 4xl:px-16 flex flex-col items-center justify-between mt-[150px]'> 
        ...
        <p
        className='text-[1.3rem] mx-auto text-center mt-[20px] bg-[#b5d9c7] p-[20px] rounded-xl'
