...
const SectionTwo = () => {
  return (
    ...
    <div className='flex flex-wrap justify-center items-center border-[#b5d9c7] border-[4px] rounded-xl h-[fit-content] w-[fit-content]'>
        <div className='w-[25vw] m-[10px] h-[200px] flex flex-col justify-center items-center'>
          <BiLeaf
          size={50}
          />
          <h3
